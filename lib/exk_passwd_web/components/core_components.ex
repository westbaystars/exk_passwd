defmodule EXKPasswdWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ScoutDragonPhoenixWeb.Gettext
  ...
  def toggle_list(assigns) do
    ...
    <div id={@id} class="join join-vertical gap-4">
      ...
      <div class="w-full flex flex-wrap gap-4">
        <div
          :for={value <- @values}
          class={"btn border rounded-none hover:border-primary cursor-pointer w-3 h-3 " <>
  ...
  defp error(assigns) do
    ...
    <p class="mt-1.5 flex gap-2 items-center text-sm text-error">
      <.icon name="hero-exclamation-circle" class="size-5" /> er_slot(@inner_block)}
    </p>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ScoutDragonPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ScoutDragonPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
